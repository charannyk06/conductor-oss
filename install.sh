...
echo -e "  ${CYAN}co init${RESET}              ${DIM}# scaffold workspace config + CONDUCTOR.md${RESET}"
echo -e "  ${CYAN}co start${RESET}             ${DIM}# start the orchestrator${RESET}"
echo ""
echo -e "Also check prerequisites: ${CYAN}gh${RESET} CLI, ${CYAN}claude${RESET} or ${CYAN}codex${RESET}"
