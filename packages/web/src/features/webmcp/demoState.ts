...
export function createInitialDemoState(): DemoState {
  return {
    workspaceName: "Conductor / WebMCP",
    workspaceLabel: "Demo workspace · no real agents or repositories",
    projects: [
      {
        id: "demo-web",
        name: "demo-web",
        description: "Polish the public challenge control surface.",
      ...
      },
      {
        id: "demo-core",
        name: "demo-core",
        description: "Harden tool schemas and confirmation gates.",
      ...
      },
      {
        id: "demo-docs",
        name: "demo-docs",
        description: "Prepare the technical walkthrough and submission.",
    ...
    sessions: [
      {
        ...
        agent: "codex",
        branch: "feat/webmcp-demo",
        summary: "The public challenge route is being tightened for clarity and keyboard use.",
      ...
      },
      {
        ...
        title: "Confirmation gate review",
        status: "needs_input",
        agent: "claude-code",
        branch: "feat/tool-safety",
        summary: "This session is waiting for explicit approval before operator feedback can be sent.",
      ...
      },
      {
        ...
        agent: "gemini",
        branch: "docs/webmcp-judge-flow",
        summary: "The walkthrough is staged for review with demo-only diffs and bounded actions.",
