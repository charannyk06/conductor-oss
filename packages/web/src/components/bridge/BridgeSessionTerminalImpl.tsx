...
function attachMobileTouchScrollShim(terminal: Terminal, host: HTMLElement): (() => void) | null {
  ...
  const dispatchTerminalWheel = (deltaX: number, deltaY: number, clientX: number, clientY: number) => {
